...
```{r, include=FALSE}
# make SbyE for CCA
SbyE_site_sub2 <- as.matrix(SbyE_site_sub[,-c(1:3,7,9:12,14,18,20)]) #4
head(SbyE_site_sub2)
...
### 2f) No SWCH version of CCA
```{r, include = FALSE}
SbyE_site_sub %>% dplyr::filter(species != 'SWCH') -> noSwch_cca
...
noSwch_geog <- SbyE_site_geog[c(1:8,13:15),]
